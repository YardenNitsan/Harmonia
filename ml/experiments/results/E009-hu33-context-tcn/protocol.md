...
## Predeclared E009 follow-up after E007/E008

E007/E008 full-validation results are now recorded: primary scores 0.310195 and
0.290422, with severe triad/seventh collapse. Before any E009 training, authorize
one additional candidate, `E009-hu33-context-tcn`, to compare against E007. Change
only the number of TCN blocks from three to six; keep E007's seed, unweighted
losses, crops, features, optimization, stopping, resources and data unchanged.
This increases the receptive field from 15 to 127 feature frames (about 0.35 to
2.95 seconds). It also increases parameter count; the comparison tests combined
context/capacity and does not isolate context from capacity.

Use the same internal checkpoint proxy and full-validation primary rule. Compare
E009 to the E007 research leader; apply the same 0.001 score tie and runtime rule,
with E007 preferred for practically equal runtime because it has fewer blocks.
No further candidates follow this bounded study. If E009 offers no clear gain,
record saturation under this recipe rather than conducting an arbitrary search.
Improvement does not authorize promotion or opening the locked test.

This is an explicitly adaptive third candidate chosen after reviewing the first
two validation outcomes, not part of the original two-candidate declaration.
The original protocol bytes and hash are preserved in
`ml/experiments/results/E007-E008-hu33-protocol.md` and the original HU33 registry.
E009 receives a separate preflight, config, reports and registry with this
amended protocol's hash recorded before execution.
